...
This marketplace keeps the work flow separate from the wallet flow. Employers manage jobs and offers from Activity. Contractors use Wallet only for tokens.
...
5. Contractor receives `OFFER_SELECTED` and can unlock contact for 1 token.
